...
button.addEventListener('click', () => {
    //application programing interface call
    fetch('https://randomuser.me/api/?gender=female')
        ...
        .then(data => {
           ...
           <div class="icon" data-title='Hi, my date birth is' data-content=${user.dob.date}>
           ...
           <div class="icon" data-title='Hi, my number is' data-content=${user.phone}>
